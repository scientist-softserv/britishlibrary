  ...
  module Writers
    ...
    module HyraxWorkWriter
      ...
      private
        ...
        def resource_type
          return nil if types['resourceTypeGeneral'].blank?
        ...
        def build_hyrax_work_related_identifier
          ...
          selected_identifiers = related_identifiers.reject { |i| ['references', 'issn', 'eissn'].include?(i['relatedIdentifierType'].downcase.strip) || i['relationType'].casecmp("references").zero? }
        ...
        def publication_date
          ...
          if date_hash.present?
            date = [date_hash['year'], date_hash['month'], date_hash['day']].reject(&:blank?)
            date = date.join('-')
          end
